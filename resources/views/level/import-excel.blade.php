<form action="{{ route('level.import.excel.post') }}" method="post" id="form-import" enctype="multipart/form-data">
    @csrf

    <div id="modal-master" class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalLabel">Import Data Level</h5>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ asset('template_data_level.xlsx') }}" class="btn btn-info btn-sm">
